...
public class UsuarioDAOImpl implements UsuarioDAO {
    ...
    // Ahora acepta nombre, apellido y correo además de los 3 campos originales
    public boolean registrarUsuario(String username, String passwordHash, String rol,
        ...
        log.info("Registrando usuario: " + username + ", rol: " + rol);
        ...
        try (Connection conexion = Conexion.getInstancia().conectar();
            ...
            log.log(Level.SEVERE, "Error al registrar usuario: " + username, e);
            return false;
        }
    }
    ...
    public boolean actualizarPassword(String username, String nuevoPasswordHash) {
        log.info("Actualizando contraseña para usuario: " + username);
        ...
        try (Connection conexion = Conexion.getInstancia().conectar();
            ...
            log.log(Level.SEVERE, "Error al actualizar contraseña para usuario: " + username, e);
            return false;
        }
    }
    ...
    public boolean insertar(Usuario objeto) {
        // Delega a registrarUsuario pasando los 6 campos
    ...
    public List<Usuario> listar() {
        ...
        try (Connection conexion = Conexion.getInstancia().conectar();
            ...
            while (tablaResultado.next()) {
                ...
                // El SP ahora devuelve: id, username, nombre, apellido, correo, rol, activo, fecha_creacion
                usuario.setId(tablaResultado.getInt(1));
                usuario.setUsername(tablaResultado.getString(2));
                usuario.setNombre(tablaResultado.getString(3));
                usuario.setApellido(tablaResultado.getString(4));
                usuario.setCorreo(tablaResultado.getString(5));
                usuario.setRol(tablaResultado.getString(6));
                usuario.setActivo(tablaResultado.getBoolean(7));
        ...
        try (Connection conexion = Conexion.getInstancia().conectar();
            ...
            try (ResultSet tablaResultado = consultaCall.executeQuery()) {
                if (tablaResultado.next()) {
                    ...
                    usuario.setUsername(tablaResultado.getString(2));
                    usuario.setRol(tablaResultado.getString(3));
                    log.info("Credenciales válidas para usuario: " + username);
                } else {
                    log.warning("Credenciales no válidas para usuario: " + username);
                }
            }
        } catch (SQLException e) {
            log.log(Level.SEVERE, "Error al validar credenciales para usuario: " + username, e);
        }
        return usuario;
    }
    ...
    public boolean activar(int id) {
        ...
        try (Connection conexion = Conexion.getInstancia().conectar();
            ...
            log.log(Level.SEVERE, "Error al activar usuario: " + id, e);
            return false;
        }
    }
}